...
# Function to generate a single row of sample data with potential anomalies
def generate_sample_data():
    ...
    # Introduce anomalies
    if random.random() < 1:  # 20% chance to introduce an anomaly
        # Example anomalies
        units_sold = random.randint(1000, 10000)  # Unusually high units sold
        unit_price = round(random.uniform(1000.0, 10000.0), 2)  # Unusually high price
        total_sales = round(units_sold * unit_price, 2)  # Recalculate total sales
